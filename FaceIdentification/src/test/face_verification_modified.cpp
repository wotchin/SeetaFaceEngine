...
*
modified by wotchin.
this program need two applacation arguments.
just like this:
./face_verification_modified.bin ./pic1.jpg ./pic2.jpg
*
*/
...
int main(int argc, char* argv[]) {
  ...
  if(argc<3){
    std::cerr<<"arguments have a fatal error!"<<std::endl;
    return -1;
}
